...
const { RendererCanvas, Space, Body, Shape, collision, Bounds, vec2, meter2pixel, pixel2meter, stats } = Physics;
...
document.addEventListener('DOMContentLoaded', () => {
    const runner = new Runner(RendererCanvas, DemoCircles);
});
